  ...
  return (
    <div id="tweet-box">
      <div id="profile-tweet">
        <img
          src="https://sportspark.online/wp-content/uploads/2020/06/1311185-1-1536x960.jpg"
          alt="profile"
          id="image-profile"
        />
      </div>
      ...
      <div id="box-tweet">
        <div id="name-id">
          <span id="flex-tweet">
            <p id="tweet-name">PANIDHAR KARANAM</p>
            <p id="tweet-id">@panidharkaranam . </p>
            <p id="tweet-date">Nov 2023</p>
          </span>
